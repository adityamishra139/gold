  ...
  return (
    <div className="px-4 md:px-8 lg:px-16 py-12">
      ...
      <section className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-bold text-amber-700 leading-tight mb-4">
      ...
      <section className="mb-20">
        <h2 className="text-2xl font-semibold text-amber-800 mb-8 text-center">Explore Categories</h2>
        <div className="grid gap-6 grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
          {["Rings", "Necklaces", "Bracelets", "Earrings", "Chains", "Pendants"].map((category, i) => (
            <div
              key={i}
              className="bg-amber-100 rounded-lg text-center py-6 hover:shadow-lg transition border border-amber-200"
            >
              <img src="/images/category-icon.svg" alt={category} className="mx-auto h-12 mb-2" />
              <p className="font-medium text-amber-700">{category}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* Featured Products */}
      <section className="mb-20">
        <h2 className="text-2xl font-semibold text-amber-800 mb-8 text-center">Best Sellers</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          {[1, 2, 3].map((id) => (
            <div key={id} className="bg-white rounded-lg shadow-md border border-amber-100 p-4">
              <img
              ...
              />
              <div className="mt-4">
                <h3 className="text-lg font-semibold text-amber-700">Gold Jewel #{id}</h3>
                <p className="text-sm text-gray-600">Beautiful handcrafted piece with intricate design.</p>
                <div className="mt-2 text-amber-600 font-bold text-lg">$1,299</div>
      ...
      {/* CTA Banner */}
      <section className="bg-gradient-to-r from-amber-100 to-amber-50 rounded-xl p-10 text-center">
        <h2 className="text-3xl font-bold text-amber-800 mb-4">Celebrate Every Moment with Gold</h2>
